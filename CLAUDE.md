...
Jalons — веб-приложение вокруг режима catastrophe naturelle: уведомляет жителей выбранных коммун в день публикации arrêté в Journal Officiel и ведёт пострадавшего через страховой случай — план действий от даты публикации, 30-дневный срок декларации, сроки страховщика, инвентарь ущерба с фото. Оно не даёт юридических консультаций и не взаимодействует со страховщиком от имени пользователя — его задача не дать пропустить сроки.
