...
-- AddForeignKey
ALTER TABLE "Commune" ADD CONSTRAINT "Commune_successorCodeInsee_fkey" FOREIGN KEY ("successorCodeInsee") REFERENCES "Commune"("codeInsee") ON DELETE SET NULL ON UPDATE CASCADE;
