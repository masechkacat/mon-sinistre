...
преемника, `nameNormalized`, сводка ручного SQL (§ 1); решения —
`docs/decisions.md`
...
| id                   | `uuid` (v7 — сортируемость по времени), генерация на стороне БД: `uuidv7()` нативна с PostgreSQL 18 (решение от 02.08.2026, `decisions.md`)   |
